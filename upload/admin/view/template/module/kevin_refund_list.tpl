...
console.log(products);	console.log(order_id);	
	...
	$.ajax({
		url: 'index.php?route=module/kevin_refund/checkQuantity&token=<?php echo $token; ?>&order_id=' + order_id + '&products=' + encodeURIComponent(prod),
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=module/kevin_refund&token=<?php echo $token; ?>';
