...
$_['text_confirm_refund'] = 'Ar tikrai norite grąžinti pinigus už šį užsakymą?';
$_['text_create_refund'] = 'Sukurti grąžinimą';
...
$_['text_missing'] = 'Trūsktami užsakymai';
$_['text_mpn'] = 'MPN:';
...
$_['text_Qty'] = 'Kiekis:';
$_['text_reason'] = 'Grąžinimo priežastis (neprivaloma)';
$_['text_refund'] = 'Grąžinti';
...
$_['text_refund_empty'] = 'Grąžinimo sumos laukas negali būti tuščias! Įveskite sumą kurią norite grąžinti.';
...
$_['text_refund_warning'] = '<span style="font-weight: 600; color:red;">kevin.</span> grąžinimai neleidžiami! Susisiekite su <a style="font-weight: 800; color:red;" href="https://kevin.eu" target="_blank">kevin.</a>';
$_['text_refund_prepare'] = 'Suma paruošta grąžinimui: %1$s. Grąžinimo statusas: "%2$s". Užsakymo Nr. %3$s.';
...
$_['column_amount'] = 'Grąžinta';
$_['column_amount_available'] = 'Suma galima grąžinimui';
$_['column_amount_ready'] = 'Paruošta grąžinimui';
...
$_['column_reason'] = 'Grąžinimo priežastis';
$_['column_refunded_amount'] = 'Grąžinta';
$_['column_refund_action'] = 'Gražinimo veiksmas';
...
$_['entry_notify'] = 'Informuoti pirkėją';
...
$_['error_auth_refund'] = 'Įvyko klaida! Jūs negalite atlikti grąžinimų. Susisiekite su <a style="font-weight: 800; color:red;" href="https://kevin.eu" target="_blank">kevin.</a>';
$_['error_amount_refund'] = 'Įvyko klaida! Grąžinama suma nebuvo įvesta. Bandykite dar kartą įvesdami grąžinamą sumą.';
$_['error_field_refund'] = 'Įvyko klaida! Patikrinkite formą, užpildykite visus privalomus laukus ir bandykite dar kartą.';
