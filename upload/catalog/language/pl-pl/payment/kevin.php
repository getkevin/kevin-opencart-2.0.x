...
*/
// Text
$_['text_amount_received'] = 'Kwota zwrócona: %s';
$_['text_card_name'] = 'Karta Kredytowa / Debetowa';
$_['text_countries'] = 'Kraje';
$_['text_kevin_payment_method'] = 'Metoda płatności: %s';
$_['text_loading'] = 'Ładowanie';
$_['text_order_info'] = 'ID zamówienia %s';
$_['text_payment_id'] = 'Identyfikator płatności: %s';
$_['text_reason'] = 'Refundowane w dniu: %';
$_['text_refund_status'] = 'Status zwrotu: %s';
$_['text_select_country'] = '-- Wybierz Kraj--';
$_['text_status'] = 'Status zamówienia: %s';
$_['text_status_group'] = 'Grupa statusu zamówienia: %s';
