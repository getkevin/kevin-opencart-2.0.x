...
*/
// Text
$_['text_amount_received']      = 'Montante devolvido: %s';
$_['text_card_name']            = 'Cartão de crédito / débito';
$_['text_countries']            = 'Paises';
$_['text_kevin_payment_method'] = 'Método de pagamento: %s';
$_['text_loading']              = 'Carregamento';
$_['text_order_info']           = 'ID DO pedido %s';
$_['text_payment_id']           = 'ID do pagamento: %s';
$_['text_reason']               = 'Reembolsado: %s';
$_['text_refund_status']        = 'Status do reembolso: %s';
$_['text_select_country']       = '-- Selecione um país--';
$_['text_status']               = 'Estado da encomenda: %s';
$_['text_status_group']         = 'Grupo de status do pedido: %s';
